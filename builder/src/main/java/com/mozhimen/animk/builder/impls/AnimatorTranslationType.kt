 ...
 * @Version 1.0
 */
open class AnimatorTranslationType : BaseAnimatorType<AnimatorTranslationType, Nothing>(), IAnimViewType<AnimatorTranslationType> {
    ...
    override fun setViewRef(view: View): AnimatorTranslationType {
    ...
    override fun build(animKConfig: MAnimKConfig): Animator {
        ...
        val translationXProperty =
            if (_isPercentageFromX && _isPercentageToY)
                object : FloatPropertyCompat<View>(View.TRANSLATION_X.name) {
        ...
        val translationYProperty =
            if (_isPercentageFromY && _isPercentageToY)
                object : FloatPropertyCompat<View>(View.TRANSLATION_Y.name) {
                    override fun setValue(obj: View, value: Float) {
